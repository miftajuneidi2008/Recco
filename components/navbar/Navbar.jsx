  ...
  return (
    <header className='w-full h-[100px] bg-gray-100 fixed z-20 '>
     <nav className='flex justify-between items-center max-container h-full '>
        <h1 className='text-2xl font-bold text-green-600'>Recco Res.</h1>
     ...
     <div className={nav?'absolute top-20 flex flex-col w-full h-screen items-center space-y-8 bg-blue-200 opacity-100 md:hidden transition-all duration-400 ease-in ':'top-[-490] opacity-0'}>
            {navLink.map((links)=>(
