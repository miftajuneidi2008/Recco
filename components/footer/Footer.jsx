  ...
  return (
   ...
   <div className='w-full bg-[#0a0a0a] opacity-90 text-white'>
      <div className='w-[90%] mx-auto flex justify-center items-center gap-10 max-md:flex-col'>
        ...
        <div className='w-2/6 flex flex-col gap-2 max-md:w-[90%] mx-auto'>
            ...
            <div className='flex flex-col gap-2'>
                <p className='text-gray-400'>South Nikkoshire,669 Kristopher Estates Apt. 305 United States of america</p>
                <p>+1 505-381-6565</p>
                <p>+1 472-221-4592</p>
            </div>
        </div>
        <div className='w-2/6 max-md:w-[90%] mx-auto'>
            ...
            <div className='bg-white py-2 rounded-full my-4 flex justify-between w-full'>
                <input type='text' name='subscribe' placeholder='Your Email Adress' className='focus:outline-none px-2 mx-2 text-black w-5/6'/>
                <button className='bg-gray-400 text-white w-[30px] h-[30px] rounded-full '><Image src={icons8} width={30} height={30} alt='logo' /></button>
            </div>
        </div>
      </div> 
      ...
      <div className='bg-[#020617] text-white'>
        <p className='text-center py-6'>Copyright &copy; {new Date().getFullYear().toString()} All rights reserved | This template is made by Recco Res</p>
      </div>
      </footer>
